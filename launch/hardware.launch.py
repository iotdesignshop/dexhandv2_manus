...
def generate_launch_description():
    ...
    descr_path = get_package_share_path('dexhandv2_description')
    default_model_path = descr_path / 'urdf/dexhandv2_cobot_right.xacro'

    dexhand_manus_path = get_package_share_path('dexhandv2_manus')
